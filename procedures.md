...
- No seu **turno**, um personagem pode se mover por uma distância igual ao perímetro da luz de sua tocha (cerca de 12 metros) e realizar **uma ação**. Os jogadores podem usar sua **ação** para se mover até três vezes essa distância, mas isso aumentará a chance de acionar uma rolagem na tabela de [**Eventos de Masmorra**](#Eventos-de-Masmorra.
